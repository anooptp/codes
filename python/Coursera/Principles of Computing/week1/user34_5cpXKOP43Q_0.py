...
def resources_vs_time(upgrade_cost_increment, num_upgrade):
    ...
    for i in range(num_upgrade):
        ...
        resources_generated += upgrade_cost_increment
        current_resources_generate_rate += rate_add_per_upgrade
        current_upgrade_cost += upgrade_cost_increment
        li.append([current_time, total_resources_generated])
        total_resources_generated += resources_generated
