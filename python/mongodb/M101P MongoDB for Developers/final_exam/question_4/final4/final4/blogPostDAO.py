...
class BlogPostDAO:
    ...
    def increment_likes(self, permalink, comment_ordinal):
        ...
        #
        post = self.posts.find_one({'permalink': permalink})
        if 'num_likes' in post['comments'][comment_ordinal]:
            post['comments'][comment_ordinal]['num_likes'] = post['comments'][comment_ordinal]['num_likes'] + 1
        else:
            post['comments'][comment_ordinal]['num_likes'] = 1
        self.posts.update({'permalink': permalink}, post)

        return post['comments'][comment_ordinal]['num_likes']
